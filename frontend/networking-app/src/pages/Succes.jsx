...
export default function Succes() {
  ...
  return (
    <div className='flex flex-col justify-center items-center px-8'>
        ...
        <Link to="/login" className='flex justify-center px-4 py-4 rounded-md border-2 bg-gradient-to-r from-[#06beb6] to-[#48b1bf] w-full sm:w-[300px] font-bold mt-8'>Go to login</Link>
    </div>
  )
}
